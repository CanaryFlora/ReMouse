...
func get_intro() -> String:
	...
	intro.append("ReMouse GDScript Console, a modified version of PankuConsole")
	intro.append("This console executes GDScript, the language ReMouse is built with")
	intro.append("Type Game.help for a list of basic commands. View the source code for more")
	return "\n".join(intro)
...
func init_module():
	...
	window.set_window_title_text("ReMouse GDScript Console")
