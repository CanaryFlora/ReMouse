...
@export_enum("Buff", "Debuff", "Mixed") var type : String
## The StatChanges this effect is composed of.
...
var timer : Timer
## The effect container of this effect.
var effect_container : Control
